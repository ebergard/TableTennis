...
from classes import Participant, Couple, Game, Day
...
def nobody_plays_this_day(game, day):
    ...
    if SINGLE:
        ...
        players.append(game.player1.participant1)
        players.append(game.player1.participant2)
        players.append(game.player2.participant1)
        players.append(game.player2.participant2)
